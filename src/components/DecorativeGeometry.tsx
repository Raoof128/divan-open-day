...
function PomegranateCypress() {
  return (
    <>
      ...
      <circle cx="88" cy="72" r="3" /><circle cx="100" cy="66" r="3" /><circle cx="112" cy="72" r="3" />
...
function ReedRosette() {
  return (
    <>
      ...
      <circle cx="28" cy="36" r="3" /><circle cx="172" cy="44" r="3" /><circle cx="154" cy="22" r="2" />
    </>
  );
}

export function DecorativeGeometry({ motif, className = '' }: DecorativeGeometryProps) {
  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={isField ? 1 : 2}>
